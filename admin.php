...
<!-- TOP NAV -->
<section class="awit is-fixed-top" id="myHeader">
<section class="hero ">
  <div class="hero-body">
...
<div class="columns has-text-centered" style="height: 100px; background-color: #f2f2f2;">
  <div class="column is-5" style="padding-top: 20px;" >
    <span style="padding-left: 20px;">  ADMIN LIST  </span> 
  </div>
   <div class="column is-10" style="padding-top: 30px;">
    <span>
    <div>

      <button style="margin: 0; margin-left: 250px;" class="button is-green modal-button" data-target="#myModal" aria-haspopup="true"><i class="fas fa-user-plus"></i> ADMIN</button>
  ...
  <div class="modal-card">
    <header class="modal-card-head">
     ...
     <form method="POST" class="modal-card-body">
                      ...
                      <div class="control">
                        <input class="input1" type="password" name="cpassword" placeholder="Confirm Password" required="">
                      </div>
                      <div class="control">
                        <input class="input1" type="number" name="contact" placeholder="Contant Number" required="">
                      </div>
                      <div class="control">
